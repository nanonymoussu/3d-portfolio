...
const Hero = ({ scrollContainer }) => {
  return (
    <section className="parallax">
      ...
      <img className="parallax__planets" src="./parallax/planets.svg" alt="" />
      <img className="parallax__mountain1" src="./parallax/mountain1.svg" alt="" />
      <img className="parallax__mountain2" src="./parallax/mountain2.svg" alt="" />
      <img className="parallax__crater" src="./parallax/crater.svg" alt="" />
      <img className="parallax__sun" src="./parallax/sun.svg" alt="" />
